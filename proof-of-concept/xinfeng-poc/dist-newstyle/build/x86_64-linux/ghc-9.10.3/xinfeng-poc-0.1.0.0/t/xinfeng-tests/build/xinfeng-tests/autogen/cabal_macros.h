...
/* package xinfeng-poc-0.1.0.0 */
#ifndef VERSION_xinfeng_poc
#define VERSION_xinfeng_poc "0.1.0.0"
#endif /* VERSION_xinfeng_poc */
#ifndef MIN_VERSION_xinfeng_poc
#define MIN_VERSION_xinfeng_poc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_xinfeng_poc */
...
#define CURRENT_COMPONENT_ID "xinfeng-poc-0.1.0.0-inplace-xinfeng-tests"
