...
-- at runtime using the environment variable xinfeng_poc_bindir.
...
-- environment variable xinfeng_poc_libdir.
...
-- using the environment variable xinfeng_poc_dynlibdir.
...
-- runtime using the environment variable xinfeng_poc_datadir.
...
-- variable xinfeng_poc_libexedir.
...
-- using the environment variable xinfeng_poc_sysconfdir.
...
bindir     = "/home/grass/.cabal/bin"
libdir     = "/home/grass/.cabal/lib/x86_64-linux-ghc-9.10.3-1e5d/xinfeng-poc-0.1.0.0-inplace-xinfeng-tests"
dynlibdir  = "/home/grass/.cabal/lib/x86_64-linux-ghc-9.10.3-1e5d"
datadir    = "/home/grass/.cabal/share/x86_64-linux-ghc-9.10.3-1e5d/xinfeng-poc-0.1.0.0"
libexecdir = "/home/grass/.cabal/libexec/x86_64-linux-ghc-9.10.3-1e5d/xinfeng-poc-0.1.0.0"
sysconfdir = "/home/grass/.cabal/etc"

getBinDir     = catchIO (getEnv "xinfeng_poc_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "xinfeng_poc_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "xinfeng_poc_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "xinfeng_poc_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "xinfeng_poc_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "xinfeng_poc_sysconfdir") (\_ -> return sysconfdir)
